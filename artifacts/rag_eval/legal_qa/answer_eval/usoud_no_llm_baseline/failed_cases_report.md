...
- Run timestamp: 2026-07-11T21:18:32Z
- Run name: `usoud_no_llm_baseline`
...
- Metric values: strict_all=0.050, strict_gold=0.100, usable_gold=1.000, citation_rate_gold=1.000, unsupported_risk_gold=0.000, retrieval_miss_gold=0.000
- Gold count: 10
...
- usable_partial_support: 6
- weak_partial_support: 3

## Top failed cases

- usoud-qa-001: usable_partial_support | status=partial | support=partial
- usoud-qa-002: weak_partial_support | status=partial | support=partial
- usoud-qa-003: usable_partial_support | status=partial | support=partial
...
- usable partial support diagnostics: 9
