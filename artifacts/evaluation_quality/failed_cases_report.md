...
- Run timestamp: 2026-07-10T17:30:27Z
...
- nsoud_no_llm_baseline (nsoud): strict_all=0.000, strict_gold=0.000, usable_gold=0.500, citation_rate_gold=0.500, unsupported_risk_gold=0.500, retrieval_miss_gold=0.250, gold=4, total=10, status=FAIL_WITH_REAL_NSOUD_RISK
...
- metric_denominator_warning: 2
- not_evaluable_missing_gold: 18
- true_retrieval_miss: 1
- unsupported_boilerplate_or_gap: 1
- usable_partial_support: 8
- weak_partial_support: 3
...
- usable_partial_support: 8
- weak_partial_support: 3
- retrieval/support caused failures: 2
- bad/incomplete gold data caused failures: 18
...
- retrieved top-k ids: 735, ECLI:CZ:NS:2024:11.TDO.765.2024.1, 991, ECLI:CZ:NS:2025:3.TDO.53.2025.1, 1834, ECLI:CZ:NS:2025:6.TDO.21.2025.1, 930, ECLI:CZ:NS:2025:11.TDO.875.2024.1, 343, ECLI:CZ:NS:2024:6.TDO.976.2024.1
- expected source absent in top-k: True
- true_retrieval_miss: True
- gold_annotation_mismatch: False
- answer_support_gap: False
- matcher_issue: False
- question_too_generic: False
- conclusion: Conservative conclusion: true_retrieval_miss. Expected ECLI is absent from retrieved top-k. The query also appears generic across multiple criminal dovolani decisions, so genericity may contribute, but there is no evidence of matcher mismatch.
