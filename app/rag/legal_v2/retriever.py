...
class LegalV2HybridRetriever:
    ...
    def retrieve(self, query_spec: QuerySpecV2) -> LegalV2RetrievalResult:
        ...
        documents = _aggregate_documents(fused, dense=dense, bm25=bm25, limit=self._config.candidate_documents)
...
def _aggregate_documents(
    ...
    *,
    ...
    documents.sort(key=lambda doc: (-doc.score, doc.document_id))
