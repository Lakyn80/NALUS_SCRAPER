...
class QuerySpecV2:
    ...
    def from_dict(cls, payload: dict[str, Any]) -> "QuerySpecV2":
        return cls(
            ...
            intent=QueryIntent(str(payload.get("intent") or QueryIntent.UNKNOWN.value)),
...
def _constraint_from_dict(payload: dict[str, Any]) -> QueryConstraint:
    return QueryConstraint(
        ...
        category=ConstraintCategory(str(payload.get("category") or "")),
        value=str(payload.get("value") or ""),
        normalized_value=str(payload.get("normalized_value") or ""),
        polarity=ConstraintPolarity(str(payload.get("polarity") or "")),
