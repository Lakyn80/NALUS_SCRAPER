...
def build_source_inventory(
    *,
    ...
    buckets = [
        _inventory_nalus_batches(batches_dir),
        _inventory_nsoud_chunks(nsoud_chunks_path),
    ]
...
def _inventory_nalus_batches(batches_dir: Path) -> SourceBucket:
...
def _inventory_nsoud_chunks(path: Path) -> SourceBucket:
